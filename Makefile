##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.2.0] date: [Wed Nov 27 19:07:16 CST 2019] 
##########################################################################################################################
...
upload: $(BUILD_DIR)/$(TARGET).elf
	openocd -f interface/cmsis-dap.cfg -f target/stm32f1x.cfg -c "program build/$(TARGET).elf verify reset exit"
